...
class ConfigurationRepository extends ServiceEntityRepository
{
    ...
    private static function typeConversion(): array
    {
        return [
            ...
            AdServerConfig::CampaignExperimentMinBudget->name => ConfigType::Integer,
            ...
            AdServerConfig::JoiningFeeEnabled->name => ConfigType::Bool,
            AdServerConfig::JoiningFeeMinValue->name => ConfigType::Integer,
            AdServerConfig::JoiningFeeValue->name => ConfigType::Integer,
