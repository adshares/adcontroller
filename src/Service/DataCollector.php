...
class DataCollector
{
    private const KEY_MAP = [
        ...
        AdServerConfigurationClient::JOINING_FEE_ENABLED => AdServerConfig::JoiningFeeEnabled,
        AdServerConfigurationClient::JOINING_FEE_MIN_VALUE => AdServerConfig::JoiningFeeMinValue,
        AdServerConfigurationClient::JOINING_FEE_VALUE => AdServerConfig::JoiningFeeValue,
